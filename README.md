...
- Анализируя тело `Main`, замечаем, что эта функция сначала выводит приглашение на ввод пароля, а затем вызывает функцию `sub_124`, которая, используя функцию DOS'а под номером 3Fh обрабатывает ввод пользователя. Делаем вывод, что `sub_124 = GetInput` Из этой функции мы можем извлечь полезную для взлома информацию:
